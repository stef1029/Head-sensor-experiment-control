...
if __name__ == "__main__":
    ...
    # notes = "test of strong Pitx2 terminal stimulation in SC"
    ...
    at_brain_power_levels = [2, 4, 8, 16, 24]      
    stim_times_ms = [250]        
    num_cycles = 40
    stim_delay = 10000
    pulse_freq = 30
    ...
    notes = "4x fiber array in SC, -1.4ML, position 4"
